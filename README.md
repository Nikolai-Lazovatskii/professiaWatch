...
3. Заходит в каждое новое объявление, матчит полный текст по ключевым словам без учёта диакритики: strong = 2 балла, weak = 1. Порог — `min_score: 2`.
...
- `min_score` — подними до 3–4, если слишком много шума; опусти до 1, если слишком тихо.
